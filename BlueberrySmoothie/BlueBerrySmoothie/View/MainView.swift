...
struct MainView: View {
    ...
    private func startButton(arrivalBusStopLocal: BusStopLocal?) -> some View {
        Button(action: {
            ...
            // 라이브 액티비티 시작
            LiveActivityManager.shared.startLiveActivity(stationName: selectedAlert.arrivalBusStopNm, initialProgress: 3, currentStop: selectedAlert.arrivalBusStopNm, stopsRemaining: 3)
